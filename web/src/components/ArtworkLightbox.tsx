      ...
      >
        <img
          ...
          className={`max-h-full max-w-full object-contain ${
            isDragging ? '' : 'transition-transform duration-200 [transition-timing-function:var(--ease-liturgico)]'
          } shadow-2xl rounded-sm animate-in zoom-in-95 fade-in duration-200`}
          style={{
